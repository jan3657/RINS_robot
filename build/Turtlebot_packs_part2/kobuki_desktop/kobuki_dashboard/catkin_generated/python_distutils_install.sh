...
echo_and_run cd "/home/team_beta/Rins/src/Turtlebot_packs_part2/kobuki_desktop/kobuki_dashboard"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/team_beta/Rins/src/Turtlebot_packs_part2/kobuki_desktop/kobuki_dashboard/setup.py" \
     \
    build --build-base "/home/team_beta/Rins/build/Turtlebot_packs_part2/kobuki_desktop/kobuki_dashboard" \
    install \
    --root="${DESTDIR-/}" \
