...
"""autogenerated by genpy from task3/Ring.msg. Do not edit."""
import codecs
import sys
...
class Ring(genpy.Message):
  _md5sum = "7bea905b7bcc3afe55c73f5ff0b51f52"
  _type = "task3/Ring"
...
float64 w
"""
  __slots__ = ['color','distance','position']
  _slot_types = ['string','float32','geometry_msgs/PoseStamped']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_f3I().pack(_x.distance, _x.position.header.seq, _x.position.header.stamp.secs, _x.position.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.distance, _x.position.header.seq, _x.position.header.stamp.secs, _x.position.header.stamp.nsecs,) = _get_struct_f3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
