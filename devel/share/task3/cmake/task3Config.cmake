...
if("TRUE" STREQUAL "TRUE")
  set(task3_SOURCE_PREFIX /home/team_beta/Rins/src/task3)
  set(task3_DEVEL_PREFIX /home/team_beta/Rins/devel)
  set(task3_INSTALL_PREFIX "")
  set(task3_PREFIX ${task3_DEVEL_PREFIX})
else()
  set(task3_SOURCE_PREFIX "")
  set(task3_DEVEL_PREFIX "")
  set(task3_INSTALL_PREFIX /home/team_beta/Rins/install)
...
if(NOT "/home/team_beta/Rins/devel/include;/usr/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2 " STREQUAL " ")
  set(task3_INCLUDE_DIRS "")
  set(_include_dirs "/home/team_beta/Rins/devel/include;/usr/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Jan Drole <jandrole2@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'task3' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/team_beta/Rins/src/task3/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/team_beta/Rins/devel/lib;/home/team_beta/Rins/devel/lib;/home/team_beta/ROS/devel/lib;/opt/ros/noetic/lib)
